...
class OrderEventConsumerTest {
  ...
  public void setUp() throws Exception {
    ...
    this.eventConsumer = new OrderEventConsumer(this.logger, this.orderRepository, new OrderEventMapperImpl(), this.eventPublisher);
  }
  ...
  public void givenAEventValidWhenInvokeTryPublishThenSendEvent() throws Exception {
    ...
    assertThat(result.getPrice(), is(notNullValue()));
