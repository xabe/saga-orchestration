...
import com.xabe.orchestation.infrastructure.messaging.mapper.OrderEventMapperImpl;
...
class OrderEventPublisherTest {
  ...
  public void setUp() throws Exception {
    ...
    this.eventPublisher = new OrderEventPublisher(this.logger, new OrderEventMapperImpl(), this.emitter);
  }
  ...
  private void assertPayload(final Object payload, final Event event) {
    ...
    final com.xabe.orchestation.domain.event.OrderCreatedEvent orderCreatedEvent =
        com.xabe.orchestation.domain.event.OrderCreatedEvent.class.cast(event);
